//MD: Particle Class. Stores particle information gathered from PDB and PSF files (Revision Date: 31st March 2021)
#ifndef _PARTICLE_H
#define _PARTICLE_H
#include "header.h"
#include "xyz.h"
...
//Class variables
	...
	double occupancy;			//PDB information
	double tempfactor;			//PDB information
