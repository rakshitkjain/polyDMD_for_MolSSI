//Functions to write different kinds of output files (Revision Date 31st March 2021)
...
//add routine to read number of sets if this previously exists, then modify it so that it can extract 
//data from an existing dcdfile and write header and stuff on its own
